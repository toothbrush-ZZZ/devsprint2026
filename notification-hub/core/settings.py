...
# Channel layers — Redis is used as the message broker
# When Order Gateway calls /notify/, we publish to Redis
# All connected WebSocket clients subscribed to that channel
